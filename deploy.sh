...
ARTIFACT_REGISTRY_REPO="${ARTIFACT_REGISTRY_REPO:-voxitale}"
IMAGE_REGISTRY_PREFIX="${IMAGE_REGISTRY_PREFIX:-${ARTIFACT_REGISTRY_LOCATION}-docker.pkg.dev/$PROJECT/$ARTIFACT_REGISTRY_REPO}"
TAG=$(date +%Y%m%d-%H%M%S)
TARGET="${1:-all}"

BACKEND_IMAGE="$IMAGE_REGISTRY_PREFIX/storyteller-backend:$TAG"
FRONTEND_IMAGE="$IMAGE_REGISTRY_PREFIX/storyteller-frontend:$TAG"
FFMPEG_IMAGE="$IMAGE_REGISTRY_PREFIX/storyteller-ffmpeg:$TAG"
